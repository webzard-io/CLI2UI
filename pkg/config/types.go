...
type CLI struct {
	...
	BoolFlagIncludeValue bool    `json:"boolFlagIncludeValue,omitempty" yaml:"boolFlagIncludeValue,omitempty"` // if true, bool flags will be specified in the form of `--flag=true` instead of `--flag`
}
